...
namespace CameraMap.Controllers
{
    public class CommonController : Controller
    {
        ...
        public string GetNumUnit(int? num,string unit,bool HideZero=false)
        {
            if (num==null)
            {
                return "";
            }
            if (HideZero && num.Value == 0)
            {
                return "";
            }
        ...
        public string Format(string format,double? formatValue)
        {
            if (formatValue == null)
            {
                return "";
            }
            return string.Format(format, formatValue);
        }

        public string GetDecimalUnit(decimal? num, string unit, int DecimalPosition = 1)
        {
            if (num == null)
            {
                return "";
            ...
            return string.Format("{0:N" + DecimalPosition + "}{1}", num, unit);
        }
