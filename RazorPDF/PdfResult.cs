...
namespace RazorPDF
{
    public class PdfResult : ViewResult
    {
        ...
        protected override ViewEngineResult FindView(ControllerContext context)
        {
            ...
            pdfView.Title = this.Title;
            if (string.IsNullOrEmpty(this.Title) && this.ViewBag.Title != null)
            {
                pdfView.Title = string.Format("{0}", this.ViewBag.Title);
            }
            pdfView.OfficeName = this.OfficeName;
